...
function icc_load_assets()
{
    ...
    wp_register_script( 'cookieconsent-script', $src.'/cookieconsent.js', array(), CCVERSION );
    wp_enqueue_script( 'cookieconsent-script' );
    wp_register_style( 'cookieconsent-style',  $src.'/cookieconsent.css', array(), CCVERSION );
...
function icc_options_page() {
    echo '<form method="post" action="options.php">';
        ...
        <table class="form-table">
            <tr class="no-display"><th colspan="2">1. Position</th></tr>
            <tr class="no-display">
                <td>
            ...
            <tr class="no-display"><th colspan="2">2. Layout</th></tr>
            <tr class="no-display">
                <td>
            ...
            <tr class="no-display"><th colspan="2">3. Palette</th></tr>
            <tr class="no-display">
                <td colspan="2">
...
<!--                    <input type="radio" id="let-opt-out" name="choose-cookie-compliance" value="opt-out" --><?php //echo get_option('choose-cookie-compliance')=='opt-out' ? 'checked' : '' ?><!-->
<!--                    <label for="let-opt-out">Let users opt out of cookies (Advanced)</label><br />-->
<!--                    <input type="radio" id="ask-to-opt" name="choose-cookie-compliance" value="opt-in" --><?php //echo get_option('choose-cookie-compliance')=='opt-in' ? 'checked' : '' ?><!-->
<!--                    <label for="ask-to-opt">Ask users to opt into cookies (Advanced)</label><br />-->
<!--                    <p>For more information about compliance see <a href="http://cookieconsent.insites.com/documentation/compliance/" target="_blank">documentation</a></p>-->
            ...
            <tr>
                ...
                <td>
                    <span id="text-policylink-container"><p><b>Policy link text</b></p><input type="text" name="link-text" placeholder="Learn more" maxlength="90" value="<?php echo get_option('link-text') ?>" /></span><br />
                    <span id="text-deny-container"><p><b>Deny button text</b></p><input type="text" name="deny-text" placeholder="Refuse cookies" maxlength="90" value="<?php echo get_option('deny-text') ?>" /></span>
                </td>
            </tr>
            <tr class="no-display"><th colspan="2"><span style="color:gray">Advanced</span>: Custom attributes</th></tr>
            <tr class="no-display">
                <td colspan="2">
